...
- `macUSB/Features/Analysis/Logic/macOS/MacOSCreateInstallMediaArchitecture.swift` — `lipo -archs` inspection and normalized Apple Silicon/Intel/universal classification.
